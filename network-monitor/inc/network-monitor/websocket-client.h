...
public:
    /*! \brief Construct a WebSocket client client.
     *
     *  \note This constructor doesn't initiate a connection.
     *
     ...
     *  \param onMessage    Called only when message is successfully
     *                      received. The message is an rvalue references;
